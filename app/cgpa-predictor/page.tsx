...
export default function CGPAPredictor() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-orange-900 to-slate-900">
      {/* Header */}
      <header className="bg-slate-900/95 backdrop-blur-sm shadow-xl border-b border-orange-500/20 sticky top-0 z-50">
          ...
          <Card className="mb-8 bg-slate-800/80 border-slate-700 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-gray-300 space-y-2">
                <p className="font-mono bg-slate-700/50 p-2 rounded">
