...
Generated by: NFS - Notes for Study
    `.trim()
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                />
                <h1 className="text-2xl font-bold text-white">📝 Marks Calculator</h1>
              </div>
            </div>
          </div>
        </div>
          ...
          <Card className="mb-8 bg-slate-800/80 border-slate-700 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription className="text-gray-300">
                Comprehensive marks calculator for all subject types
              </CardDescription>
            </CardHeader>
          </Card>

          <Tabs defaultValue="theory" className="space-y-6">
            <TabsList className="grid w-full grid-cols-5 bg-slate-800/80 border-slate-700">
              <TabsTrigger value="theory" className="data-[state=active]:bg-slate-700 text-gray-300">
                Theory
              </TabsTrigger>
              <TabsTrigger value="hybrid" className="data-[state=active]:bg-slate-700 text-gray-300">
                Hybrid
              </TabsTrigger>
              <TabsTrigger value="hybrid2nd" className="data-[state=active]:bg-slate-700 text-gray-300">
                Hybrid 2nd Yr
              </TabsTrigger>
              <TabsTrigger value="practical" className="data-[state=active]:bg-slate-700 text-gray-300">
                Practical
              </TabsTrigger>
              <TabsTrigger value="online" className="data-[state=active]:bg-slate-700 text-gray-300">
                Online
              </TabsTrigger>
            </TabsList>
